...
export default function ResultsCard({ bet, selectedBookKey }) {
  ...
  return (
    <div
      ...
      className="rounded-2xl border border-white/5 bg-novig-card p-8"
    >
      <div>
        <div className="mb-2 section-label">You're losing</div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <div className="section-label">Over 100 bets like this</div>
            <div className="mt-1 text-2xl font-bold text-red-300">
              {formatCurrency(lostOverHundred)} lost
            </div>
          </div>
          <div>
            <div className="section-label">On Novig</div>
